 ...
 * @author guzman
 */
@WebServlet(name = "CustomerBorrarServlet", urlPatterns = {"/CustomerBorrarServlet"})
public class CustomerBorrarServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        this.customerFacade.borrar(new Integer(id));
